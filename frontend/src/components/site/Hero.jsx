...
export default function Hero({ onBook }) {
  return (
    <section id="top" className="relative pt-24 md:pt-28 pb-16 md:pb-24 overflow-hidden">
      ...
      <div className="absolute top-32 -right-32 w-[480px] h-[480px] rounded-full bg-[#D4AF37]/10 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 -left-20 w-[420px] h-[420px] rounded-full bg-[#B65F33]/10 blur-3xl pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-6 animate-fade-up">
          <div className="inline-flex items-center gap-2 rounded-full bg-[#F2EBE1] border border-[#E5DCD0] px-3 py-1.5 text-xs font-medium text-[#9E4F28] mb-6">
          ...
          >
            Premium <span className="italic text-[#B65F33]">car hire</span> in Giyani —
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Button
              ...
              onClick={onBook}
              className="rounded-full bg-[#B65F33] hover:bg-[#9E4F28] text-[#F9F6F0] px-6 h-12 text-base shadow-md hover:-translate-y-0.5 transition-all"
            >
        ...
        <div className="lg:col-span-6 relative animate-fade-up" style={{ animationDelay: "120ms" }}>
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-[#E5DCD0]">
            <img
              src={HERO_IMG}
            ...
            <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between gap-3">
              <div className="rounded-2xl bg-[#F9F6F0]/95 backdrop-blur-md border border-white/40 px-4 py-3 shadow-lg">
              ...
              <div className="rounded-2xl bg-[#1A1A1A]/85 backdrop-blur-md text-[#F9F6F0] px-4 py-3 shadow-lg flex items-center gap-2">
                <ShieldCheck className="h-5 w-5 text-[#D4AF37]" />
                <div>
                  <div className="text-[10px] uppercase tracking-wider text-[#F9F6F0]/70">Tracker + Dashcam</div>
          ...
          <div className="hidden md:block absolute -left-6 top-10 animate-gentle-float">
            <div className="rounded-2xl bg-white shadow-xl border border-[#E5DCD0] px-4 py-3 text-sm">
              <div className="text-[10px] uppercase tracking-wider text-[#B65F33] font-semibold">Reg</div>
